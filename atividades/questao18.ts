...
async function main() {
    ...
    let index = achaIndiceDoPrimeiroElementoEncontrado(arr, recebendoNum)
    if(index !== -1){
...
function achaIndiceDoPrimeiroElementoEncontrado(arr: number[], recebendoNum: number): number {
